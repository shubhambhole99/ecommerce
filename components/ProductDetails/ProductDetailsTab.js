...
function ProductDetailsTab({ products }) {
        ...
        <div className="tab products-details-tab">
            <ul className="tabs">
                {products.map((product, index) => (
                    <li key={index} onClick={(e) => { e.preventDefault(); openTabSection(e, `tab${index + 1}`) }} className={index === 0 ? "current" : ""}>
                        <a href="#">
            ...
            <div className="tab-content">
                {products.map((product, index) => (
                    <div key={index} id={`tab${index + 1}`} className={`tabs-item ${index === 0 ? "fadeInUp animated" : ""}`}>
                        <div className="products-details-tab-content">
                            <p>{product.description}</p>

                            {/* ...other content for the product... */}
                        </div>
                    </div>
                ))}
